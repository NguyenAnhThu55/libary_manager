...
<head>
    ...
    <!-- Datatables css -->
    <link href="{{ asset('/public/backend/assets/css/vendor/dataTables.bootstrap5.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('/public/backend/assets/css/vendor/responsive.bootstrap5.css') }}" rel="stylesheet"
        type="text/css" />
...
<body class="loading text-dark"
    ...
    <div class="wrappers" style="background-color: #fff">
        ...
        <div class="leftside-menu">
            ...
            <a href="{{ URL::to('trang-chu') }}" class="logo text-center logo-light">
                <span class="logo-lg">
                    <img src="{{ url('/public/image/logo.png') }}" alt="" height="80">
                </span>
                <span class="logo-sm">
                    <img src="{{ url('/public/image/LOGO_SM.png') }}" alt="" height="90">
                </span>
            </a>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEcommerce1">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ url::to('/register-auth') }}">Đăng Ký Tài Khoảng</a>
                                </li>

                                <li>
                                    <a href="{{ url::to('/all-users') }}">Phân Quyền Tài Khoảng</a>
                                </li>
                    ...
                    <li class="side-nav-item">
                        <a href="{{ url::to('/list-soft') }}" class="side-nav-link">
                            <i class="uil-clipboard-alt"></i>
                            <span>Tài Liệu Mềm</span>
                        </a>
                    </li>
                    {{-- users management  --}}
                    <li class="side-nav-item">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarPages">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ url::to('/manage-borrow') }}">Thống Kê Danh Sách</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <ul class="list-unstyled topbar-menu float-end mb-0">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a href="" class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown"
                                ...
                                <img src="{{ url('/public/backend/image/flags/vn.png') }}" alt="user-image"
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu">
                                ...
                                <a href="{{ url('/lang/en') }}" class="dropdown-item notify-item">
                                    <img src="{{ url('/public/backend/image/flags/us.jpg') }}" alt="user-image"
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                ...
                                <span class="account-user-avatar">
                                    <?php
                                            $id = Session::get('admin_id');
                                            $get_img = DB::table('tbl_admin')->where('admin_id','=',$id)->get();
                                            foreach ($get_img as $img) {
                                                if($img->admin_image == null) {

                                                
                                    ?>
                                    <img src="{{ url('public/image/Avatar-trang-den.png') }}" alt="user-image"
                                    ...
                                    <?php
                                                ...
                                                ?>
                                    <img src="{{ url('public/image/' . $img->admin_image) }}" alt="user-image"
                                        class="rounded-circle">
                            ...
                            <div
                                ...
                                <!-- item-->
                                <a href="{{ URL::to('/view-profile') }}" class="dropdown-item notify-item">
                    ...
                    <div class="app-search dropdown d-sm-block float-left">
                        <form action="{{ URL::to('/search') }}" method="POST">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control dropdown-toggle" name="keywords_submit"
                                    placeholder="Tìm kiếm..." id="keywords_submit">
                                <span class="mdi mdi-magnify search-icon d-lg-none d-sm-block"></span>
                                <button class="input-group-text btn-primary d-lg-block d-none" type="submit"><i
        ...
        <footer class="footers"
            style=" border-top: 1px solid rgba(152,166,173,.2);
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        </script> @b1910584 - Nguyen Anh Thu
                    </div>
                    <div class="col-md-4">
    ...
    {{-- update status borrow TTHL --}}
    <script type="text/javascript">
        $('.borrow_detail_tthl_status').change(function() {
            var order_status_tthl = $(this).val();
            var order_id_tthl = $(this).children(":selected").attr("id");
            var _token = $('input[name="_token"]').val();
            // alert(order_status_tthl);
            // alert(order_id_tthl);
            // alert(_token);
            $.ajax({
                url: "{{ url('/update-book-borrow-tthl-status') }}",
                method: 'POST',
                data: {
                    order_status_tthl: order_status_tthl,
                    order_id_tthl: order_id_tthl,
                    _token: _token,
                    _token: _token
                },
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#check_user_code').on('keyup', function() {
                ...
                var choose_loan = $("#choose-loan").val();
                $.ajax({
                    url: "{{ url('/check-user') }}",
                    method: 'GET',
                    data: {
                        user_code: user_code,
                        choose_loan: choose_loan
                    },
                    success: function(data) {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.chose-number-be').on('change', function() {
                var number = $(this).val();
                // alert (number)
                $.ajax({
                    url: "{{ url('/chose-number-be') }}",
                    method: 'GET',
                    data: {
                        number: number
                    },
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#select_type_books').on('change', function() {
                var value_type = $(this).val();
                // var value_search = $('input[name="search_list"]').val();

                // alert(value_search);
                // alert(value_type);

                $.ajax({
                    url: "{{ url('/check-type-books') }}",
                    method: 'GET',
                    data: {
                        value_type: value_type
                    },
                    success: function(data) {
                        $('#show_type_books').html(data);
                    }
                });
            })
        });
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#search_list_input').on('keyup', function() {
                var value_search_input = $('input[name="search_list"]').val();
                var value_type_input = $('select[id="select_type_books"]').val();

                // alert(value_search);
                // alert(value_type);

                $.ajax({
                    url: "{{ url('/check-search-list') }}",
                    method: 'GET',
                    data: {
                        value_search_input: value_search_input,
                        value_type_input: value_type_input
                    },
                    success: function(data) {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#manage_borrow').on('change', function() {
                var value_borrow = $('select[id="list_manage_borrow"]').val();
                //    alert(value_borrow);
                $.ajax({
                    url: "{{ url('/search-borrow-books') }}",
                    method: 'GET',
                    data: {
                        value_borrow: value_borrow
                    },
                    success: function(data) {
                        $('#list_search_borrow').html(data);
                    }
                });
            })
        });
    </script>
    {{-- end list borrow manage --}}

    {{-- list borrow manage TTHL --}}
    <script type="text/javascript">
        $(document).ready(function() {
            $('#manage_borrow_tthl').on('change', function() {
                var value_borrow = $('select[id="list_manage_borrow_tthl"]').val();
                //    alert(value_borrow);
                $.ajax({
                    url: "{{ url('/search-borrow-books-tthl') }}",
                    method: 'GET',
                    data: {
                        value_borrow: value_borrow
                    },
                    success: function(data) {
                        $('#list_search_borrow_tthl').html(data);
                    }
                });
            })
        });
    </script>
    {{-- end list borrow manage TTHL --}}
