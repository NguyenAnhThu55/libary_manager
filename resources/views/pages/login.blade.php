...
<body style="background-image: url('/public/backend/image/room-interior-design.jpg')">

  <div class="row">
    <div class="dust-paarticle">

     
      {{-- <img src="{{url('/public/backend/image/room-interior-design.jpg')}}" class="img-fluid img-index" alt="Responsive image"> --}}
      <?php
      ...
      <div id="snell" class="mt-5">
        ...
        <div class="d-flex justify-content-center mt-5">
          <h2 class="text-light">Library Manager</h2>
                  ...
                  <body class="login">
                    <div class="container">
                      <div class="login-container-wrapper clearfix">
                        ...
                        <form class="form-horizontal login-form" action="{{URL::to('/admin-login')}}" method="POST">
                          
                          @csrf
                          <div class="form-group relative">
                            <input id="login_username" name="admin_email" class="form-control input-lg" type="email"
                              placeholder="email đăng nhập" required>
                            <i class="fa fa-user"></i>
                          </div>
                          <div class="form-group relative password">
                            <input id="login_password" name="admin_password" class="form-control input-lg" type="password"
                          ...
                          <div class="checkbox pull-right">
                            <label> <a class="forget" href="" title="forget">Quên Mật Khẩu ?</a> </label>
                          </div>
                        </form>
                      </div>
