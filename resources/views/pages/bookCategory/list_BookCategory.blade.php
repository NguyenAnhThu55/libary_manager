                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/edit-book-category/'.$list_bcate->books_category_id)}}" class="action-icon text-primary"> <i class="mdi mdi-square-edit-outline"></i></a>
                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này không?');" href="{{URL::to('/delete-book-category/'.$list_bcate->books_category_id)}}" class="action-icon"> <i class="mdi mdi-delete text-danger"></i></a>
                                    </td>
                                </tr>
                            @endforeach
